    ...
    return res
      ...
      .json(
        new ApiResponse(
          200,
          {unsubscribed},
          "Toggle subscription successfully to unsubscribed "
        )
      );
  }
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        {},
        "Toggle subscription successfully to subscribed "
      )
    );
});
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        subscribers,
        "get subscribers list to channel successfully"
      )
    );
});
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        subscribed,
        "get channels list subscriber successfully"
      )
    );
});
